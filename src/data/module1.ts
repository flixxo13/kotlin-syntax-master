  ...
  concepts: [
    {
      ...
      explanation:
        'Kotlin wurde von JetBrains entwickelt und 2016 veröffentlicht. Es ist Googles bevorzugte Sprache für Android-Entwicklung und zeichnet sich durch Null Safety, Ausdrucksstärke und Interoperabilität mit Java aus.',
...
fun greet(name: String): String {
...

    {
      ...
      syntaxRule: 'fun main() { ... }',
      explanation:
        'Jedes ausführbare Kotlin-Programm braucht eine main()-Funktion als Einstiegspunkt. Das Schlüsselwort "fun" deklariert eine Funktion.',
      example: `fun main() {
    println("Hello, World!")
}`,
      exercises: [
...

    {
      ...
      explanation:
        'Literale sind direkte Werte im Code: Zahlen (42), Texte ("Hallo"), Zeichen (\'A\') und Wahrheitswerte (true/false). println() gibt sie in der Konsole aus.',
      example: `fun main() {
    println(42)
    println("Kotlin")
    println(true)
...

    {
      ...
      explanation:
        'Kotlin kennt drei Kommentartypen: Einzeilige (//), Mehrzeilige (/* */) und KDoc (/** */).',
